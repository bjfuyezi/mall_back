...
public class UserCouponService {
    ...
    public String claimCoupon(Integer user_id, Integer coupon_id) {
        ...
        // 更新优惠券库存
        if (result > 0) {
            couponMapper.decrementCouponTotal(coupon_id);
            return "优惠券领取成功";
        } else {
            return "优惠券领取失败";
        }
     ...
     *   - 用户id:user_id
     *   - 券的id:coupon_id*/
    public boolean useCoupon(Integer user_id, Integer coupon_id) {
        int affectedRows = userCouponMapper.updateCouponStatusToUsed(user_id, coupon_id);
